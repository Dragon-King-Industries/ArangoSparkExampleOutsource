...
spark = SparkSession.builder.appName('JSON to ArangoDB').getOrCreate()

# JSON files can be read directly into dataframes
df = spark.read.option("mode", "DROPMALFORMED").json(os.getenv('JSON_PATH'))
print("#Step 1#", df)
